...
namespace Game
{
    public partial class FourLinkForm2 : Form
    {
        public FourLinkForm2()
        {
            InitializeComponent(); //add load event in InitializeComponent()
        }
        ...
        private void FourLinkForm2_Load(object sender, EventArgs e)
        {
            label4_score_total.Text = GlobalData.Score_total.ToString();
        ...
        void FourLinkForm2_FormClosing(object sender, FormClosingEventArgs e)
        {
            GC.Collect();
            this.Dispose();
            Application.Exit();
        ...
        void FourLinkForm2_FormClosed(object sender, FormClosedEventArgs e)
        {
            GC.Collect();
            this.Dispose();
            Application.Exit();

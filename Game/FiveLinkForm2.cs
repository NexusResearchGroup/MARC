...
namespace Game
{
    public partial class FiveLinkForm2 : Form
    {
        public FiveLinkForm2()
        {
            InitializeComponent();
        }
        ...
        private void FiveLinkForm2_Load(object sender, EventArgs e)
        {
            label5_score_total.Text = GlobalData.Score_total.ToString();
        ...
        void FiveLinkForm2_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Dispose();
            Application.Exit();
        }

        void FiveLinkForm2_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Dispose();
            Application.Exit();
        }
